        ...
        <div class="mt-16 mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                <div class="flex items-center justify-between">
                    ...
                    <a href="forms/add_penyewa.php" class="px-4 py-2 bg-amber-500 text-white rounded-md hover:bg-amber-600 transition duration-150 ease-in-out text-sm font-medium">
                        Tambah Penyewa
                    </a>
                </div>
            </div>
